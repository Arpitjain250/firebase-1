...
public class SubmitButton extends Button {
    ...
    private StrokeDrawable mDrawableNormal;
    private StrokeDrawable mDrawablePressed;
    ...
    public StrokeDrawable getDrawableNormal() {
        return mDrawableNormal;
    }

    public void animate(@NonNull Params params) {
    ...
    private void morphWithAnimation(@NonNull final Params params) {
        ...
        ButtonAnimation.Params animationParams = ButtonAnimation.Params.create(this)
                ...
                .listener(new ButtonAnimation.Listener() {
                    @Override
        ...
        ButtonAnimation animation = new ButtonAnimation(animationParams);
        animation.start();
    }
    ...
    private void initView() {
        ...
        int cornerRadius = (int) resources.getDimension(R.dimen.corner_radius);
        int blue = resources.getColor(R.color.gray);
        int blueDark = resources.getColor(R.color.colorDisabled);
    ...
    private StrokeDrawable createDrawable(int color, int cornerRadius, int strokeWidth) {
        StrokeDrawable drawable = new StrokeDrawable(new android.graphics.drawable.GradientDrawable());
        drawable.getGradientDrawable().setShape(android.graphics.drawable.GradientDrawable.RECTANGLE);
    ...
    public static class Params {
        ...
        private String text;
        private ButtonAnimation.Listener animationListener;
        ...
        public Params animationListener(ButtonAnimation.Listener animationListener) {
