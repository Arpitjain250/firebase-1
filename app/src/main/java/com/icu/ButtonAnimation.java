...
public static class Params {
    ...
    private Params(@NonNull SubmitButton button) {
        this.button = button;
    }

    public static Params create(@NonNull SubmitButton button) {
    ...
    public Params listener(@NonNull ButtonAnimation.Listener animationListener) {
    ...
    public ButtonAnimation(@NonNull Params params) {
        mParams = params;
    }

    public void start() {
        StrokeDrawable background = mParams.button.getDrawableNormal();
